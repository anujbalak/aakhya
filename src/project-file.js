function projectFile() {
    ...
    function task(taskValue) {
        ...
        const taskFolderContainer = document.createElement('div');
        const taskFolderName = document.createElement('p');
        const removeTaskBtn = document.createElement('button');
    
        taskContainer.classList.add('task-container');
        checkbox.classList.add('checkbox');
        taskText.classList.add('task-text');
        taskFolderContainer.classList.add('task-folder-container');
        taskFolderName.classList.add('task-folder-name');
        ...
        taskContainer.appendChild(taskFolderContainer);
        taskFolderContainer.appendChild(taskFolderName);
